...
exports.addUser = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ userId: result.insertId, message: 'User added successfully' });
  } catch (error) {
...
exports.addTrain = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ trainId: result.insertId, message: 'Train added successfully' });
  } catch (error) {
